...
const uint32_t *
Cpu0RegisterInfo::getCallPreservedMask(const MachineFunction &MF, CallingConv::ID) const {
...
BitVector Cpu0RegisterInfo::getReservedRegs(const MachineFunction &MF) const {
    ...
    for (unsigned I = 0; I < sizeof(ReservedCPURegs)/2; ++I)
...
const TargetRegisterClass * Cpu0RegisterInfo::intRegClass(unsigned Size) const {
